  ...
  return (
    <div id='skills'>
      ...
      <div className="container">
        ...
        <section className='p-5 flex justify-between relative'>
          <div>
              <img src={sparkle} alt="" />
          </div>
          <div className='w-1/2 absolute right-0'>
              <h1 className="font-bold text-3xl absolute right-5">Make beauty things with passion</h1>
              <p className='mt-14 text-justify w-3/5 absolute right-5'>I provide designer and development services to businesses of all kinds, with a focus on fashionable, cutting-edge online stores, web services, and websites. Creating strong interfaces for digital user experiences is my passion.</p>
          </div>
        </section>
