  ...
  return (
    <div id="skills">
      ...
      <div className="p-10">
        ...
        {/* techstack */}
        <section className="techstacks mt-20">
        ...
        {/* <section className="certificates-section">
          <div className="flex justify-between items-center flex-wrap">
            <div className="w-9/12">
              ...
              <p className="mt-4 text-justify w-1/2">
        ...
        <section className="relative font-pop max-sm:w-full mt-20">

          <div className="lg:flex lg:items-center">
            <div className="container xl:w-9/12">
              <h2 className="font-bold max-sm:text-xl sm:text-2xl lg:text-2xl xl:text-3xl">Professional achievements</h2>
              <p className="text-justify break-words mt-4 lg:w-9/12">
                  I have pursued various certifications throughout my career to
                  continuously enhance my skills and stay updated with the latest
                  industry standards. Among my certifications, I hold a **MongoDB
